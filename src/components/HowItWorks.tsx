              ...
              return (
                <Reveal key={step.title} delay={(i % 4) * 0.1}>
                  <a
                    ...
                    className="block rounded-2xl text-center outline-none focus-visible:ring-2 focus-visible:ring-forest-700 focus-visible:ring-offset-4 focus-visible:ring-offset-cream-50"
                  >
                    <div className="relative z-10 mx-auto grid h-14 w-14 place-items-center rounded-full bg-sage-100 text-sage-700 ring-4 ring-cream-50">
                      <Icon className="h-6 w-6" />
                    </div>
                    <span className="mt-4 block text-xs font-semibold uppercase tracking-widest2 text-sage-600">
                      Passo 0{i + 1}
                    </span>
                    <h3 className="mt-1 font-display text-xl text-forest-800">
                      {step.title}
                    </h3>
